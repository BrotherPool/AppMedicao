...
public class FiscRead extends SQLiteOpenHelper {
    ...
    public FiscRead(Context context) {
    ...
    public ArrayList<Fiscalizacao> getRegistros(){
        openBD();
        ArrayList<Fiscalizacao> cArray=new ArrayList<>();
        String getFisc="SELECT * FROM "+nomeTabela;
        try {
            Cursor c=db.rawQuery(getFisc,null);
            if(c.moveToFirst()){

                do {


                    Fiscalizacao aux=new Fiscalizacao(c.getInt(0),c.getInt(1),c.getString(2),c.getString(3),
                            c.getString(4),c.getString(5),c.getString(6),c.getString(7),c.getString(8),c.getString(10),
    ...
    public Fiscalizacao getFisc(int id){
        openBD();
        Fiscalizacao j=new Fiscalizacao();
